...
Route::get('/copy-template/{template}' , [TemplateController::class , 'copyTemplate'])->name('copy-template');
});
Route::prefix('trakr')->group(function () {
	...
	Route::get('/visitor/cancel/{trakr}/{user_id}' , [TrakrViewController::class , 'cancelSignin'])->name('cancelSignin');
	Route::post('/visitor/contractor/area-access' , [TrakrViewController::class ,'areaAccess'])->name('area-access');
	// qr
