    ...
    <div class="card">
        <div class="card-header">
            <ul class="nav nav-tabs card-header-tabs " role="tablist">
                <li class="nav-item">
                    <a class="nav-link  active" id="contactus-tab" data-toggle="tab" href="#contactus"
                        role="tab" aria-controls="contactus" aria-selected="false">Contact Support</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="userguide-tab" data-toggle="tab" href="#userguide"
                        role="tab" aria-controls="userguide" aria-selected="true">Help Center</a>
                </li>
        ...
        <div class="card-body">
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="userguide" role="tabpanel"
                        ...
                        <div class="col-12" id="accordion">
                            ...
                            <div class="card d-flex mb-3">
                                <div class="d-flex flex-grow-1 min-width-zero" data-toggle="collapse" data-target="#collapseOne"
                                    ...
                                    @if(auth()->user()->is_admin)
                                    <button type="button" class="btn btn-outline-primary top-right-button  mr-1" style="border-radius:0px !important;"
                            onclick="window.location.href='{{route("support-edit",$support->id)}}'">Edit</button>
                                    @endif
                        </div>
