    ...
    <div class="sub-menu">
        <div class="scroll">
            <ul class="list-unstyled" data-link="reports">
                <li>
                    <a href="/reports">
                        <i class="simple-icon-rocket"></i> <span class="d-inline-block">Summary Report</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('summaryReport') }}">
                        <i class="simple-icon-pie-chart"></i> <span class="d-inline-block">Screening Questions</span>
                    </a>
                </li>
            </ul>
